...
int main()
{
    ...
    ellipse(img, Point(120, 300), Size(60, 30), 20, 0, 270, Scalar(255, 255, 0), -1, LINE_AA); // 타원을 0~270도까지 내부를 채워서 그림(하늘색)
    ellipse(img, Point(120, 300), Size(100, 30), 20, 0, 360, Scalar(0, 255, 0), 2, LINE_AA); // 타원을 두꼐 2인 선으로 그림(녹색)
